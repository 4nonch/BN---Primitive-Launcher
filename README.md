...
4. Display current work near progressbar (like downloading Kenan; UPT; installing CO.AG and all that stuff)
5. Add "Cancel" button to cancel updation
6. Launcher update feature 
7. Display new version description
